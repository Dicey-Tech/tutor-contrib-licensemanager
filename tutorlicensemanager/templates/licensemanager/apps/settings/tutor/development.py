...
BACKEND_SERVICE_EDX_OAUTH2_KEY = "{{ LICENSEMANAGER_OAUTH2_KEY_DEV }}"
BACKEND_SERVICE_EDX_OAUTH2_SECRET = "{{ LICENSEMANAGER_OAUTH2_SECRET }}"
BACKEND_SERVICE_EDX_OAUTH2_PROVIDER_URL = "http://lms:8000/oauth2"

SOCIAL_AUTH_EDX_OAUTH2_KEY = "{{ LICENSEMANAGER_OAUTH2_KEY_SSO_DEV }}"
...
ENTERPRISE_CATALOG_URL = "http://{{ ENTERPRISECATALOG_HOST }}:8160"
# ENTERPRISE_LEARNER_PORTAL_BASE_URL
# SUPPORT_SITE_URL

{{ patch("licensemanager-development-settings") }}