SECRET_KEY = "{{ LICENSEMANAGER_SECRET_KEY }}"
ALLOWED_HOSTS = [
    "licensemanager",
    "{{ LICENSEMANAGER_HOST }}",
    "{{ LMS_HOST }}",
...
DATABASES = {
    "default": {
        ...
        "NAME": "{{ LICENSEMANAGER_MYSQL_DATABASE }}",
        "USER": "{{ LICENSEMANAGER_MYSQL_USERNAME }}",
        "PASSWORD": "{{ LICENSEMANAGER_MYSQL_PASSWORD }}",
        "HOST": "{{ MYSQL_HOST }}",
        "PORT": "{{ MYSQL_PORT }}",
        "OPTIONS": {
...
CACHES = {
    "default": {
        ...
        "KEY_PREFIX": "licensemanager",
        "LOCATION": "redis://{% if REDIS_USERNAME and REDIS_PASSWORD %}{{ REDIS_USERNAME }}:{{ REDIS_PASSWORD }}{% endif %}@{{ REDIS_HOST }}:{{ REDIS_PORT }}/{{ LICENSEMANAGER_CACHE_REDIS_DB }}",
    }
}
...
LOGGING["handlers"]["local"] = {
    ...
    "filename": "/var/log/licensemanager.log",
    "formatter": "standard",
}
...
{{ patch("licensemanager-common-settings") }}